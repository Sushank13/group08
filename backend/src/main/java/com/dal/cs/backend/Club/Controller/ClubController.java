...
public class ClubController
{
     ...
     */
    @RequestMapping(method = RequestMethod.GET, value = "/unauthenticated/getAllJoinClubRequests/{clubID}/{presidentEmailID}")
    public List<JoinClubRequest> getAllJoinClubRequests(@PathVariable String clubID, @PathVariable String presidentEmailID) {
